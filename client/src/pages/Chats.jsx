    ...
    return (
        <div>
            ...
            <link
                rel="preload"
                as="image"
                href="https://images.pexels.com/photos/18096595/pexels-photo-18096595/free-photo-of-music-on-street.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <link
                rel="preload"
                as="image"
                href="https://images.pexels.com/photos/18094275/pexels-photo-18094275.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <link
                rel="preload"
                as="image"
                href="https://images.pexels.com/photos/13847652/pexels-photo-13847652.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <link
                rel="preload"
                as="image"
                href="https://images.pexels.com/photos/13847596/pexels-photo-13847596.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <link
                rel="preload"
                as="image"
                href="https://images.pexels.com/photos/7775636/pexels-photo-7775636.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <link
                rel="preload"
                as="image"
                href="https://images.pexels.com/photos/18107025/pexels-photo-18107025/free-photo-of-man-reading-newspaper.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <link
                rel="preload"
                as="image"
                href="https://images.pexels.com/photos/7775640/pexels-photo-7775640.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <link
                rel="preload"
                as="image"
                href="https://images.pexels.com/photos/18107024/pexels-photo-18107024/free-photo-of-an-old-city-view.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" />
            <div class="bg-[#121212]">
                <header class="fixed top-0 z-10 mx-auto flex w-full max-w-full items-center justify-between border-b-[1px] border-b-slate-300 bg-[#121212] p-4 text-white lg:px-10">
                    <h1 class="text-xl font-extrabold md:text-3xl">Inbox</h1>
                    <div class="flex w-max flex-shrink-0 items-center justify-end gap-6">
                        <span class="relative">
                            ...
                            <span class="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 p-1 text-sm text-white md:h-5 md:w-5 md:text-base">4</span>
                        </span>
                        <div class="h-11 w-11 rounded-full border-2 border-white">
                            <img
                        ...
                        <ul class="flex h-[calc(100%-140px)] w-full flex-col items-start justify-start divide-y-[1px] divide-white overflow-y-auto md:h-[calc(100%-73px)]">
                            ...
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Alice Smith</p>
                                            <p class="text-gray-400">4 hours ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">How&#x27;s it going on your end? I heard you had an exciting trip last week. Tell me all about it!</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Bob Johnson</p>
                                            <p class="text-gray-400">Yesterday</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">What&#x27;s for dinner tonight? I&#x27;m craving some Italian food. Any recommendations?</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Emily Davis</p>
                                            <p class="text-gray-400">2 days ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">Can you help me with this coding problem? I&#x27;m stuck on it for hours now.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Michael Wilson</p>
                                            <p class="text-gray-400">2 weeks ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">See you tomorrow at the park. Don&#x27;t forget to bring your running shoes!</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Sophia Anderson</p>
                                            <p class="text-gray-400">2 weeks ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">I miss you so much! It&#x27;s been ages since we hung out. Let&#x27;s plan something soon.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Liam Brown</p>
                                            <p class="text-gray-400">3 weeks ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">Let&#x27;s meet up for coffee. I have some exciting news to share with you!</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Olivia Lee</p>
                                            <p class="text-gray-400">4 weeks ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">I have some big news! Guess what? I&#x27;m getting married next month!</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Noah White</p>
                                            <p class="text-gray-400">1 month ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">How&#x27;s the weather there? I&#x27;m planning a weekend hike and hoping for good weather.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Ava Garcia</p>
                                            <p class="text-gray-400">2 months ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">Good morning! Did you catch the sunrise today? It was breathtaking.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Ethan Martinez</p>
                                            <p class="text-gray-400">3 months ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">Let&#x27;s go for a long walk by the beach this evening. The weather is perfect.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">Mia Jones</p>
                                            <p class="text-gray-400">4 months ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">Happy birthday! I hope you have an amazing day filled with joy and surprises.</p>
                                    </div>
                                </div>
                            </li>
                            <li class="w-full cursor-pointer p-4 hover:bg-[#232323] md:p-6">
                                <div class="flex w-full items-start justify-start gap-3 md:gap-4">
                                    ...
                                    <div class="flex w-full flex-col items-start justify-start gap-1 truncate text-ellipsis">
                                        <div class="flex w-full items-center justify-between text-[10px] md:text-xs">
                                            <p class="text-gray-400">James Harris</p>
                                            <p class="text-gray-400">5 months ago</p>
                                        </div>
                                        <p class="text-xs text-white md:text-sm">What&#x27;s new with you lately? I&#x27;ve been swamped with work, but I miss our chats.</p>
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="h-full w-full md:w-[70%]">
                        <div class="flex w-full items-center justify-between gap-2 border-b-[1px] border-white p-4">
                            <div class="flex w-full items-center justify-start gap-3">
                                <button class="inline-flex h-7 w-7 flex-shrink-0 items-center justify-center border-[1px] border-white p-1 md:hidden md:h-10 md:w-10">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
